  ...
  const handleWrite = async () => {
    ...
    try {
      const { hash } = await writeContract({
        ...
        abi: ABI_FILE,
        functionName: "transferMedication",
        args: [medicationID, address],
      })
      setIsLoading(false)
      console.dir(hash)
      toast({
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input
                        ...
                        placeholder="ETH Address del receptor"
                      />
                    </InputGroup>
                  </FormControl>
